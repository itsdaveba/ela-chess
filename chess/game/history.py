...
class History:
    def __init__(self) -> None:
        ...
        self.irrevs: list[tuple[Piece, Castling, Square, Counter, int]] = []
    ...
    def append(self, move: Move, irrev: tuple[Piece, Castling, Square, Counter, int]) -> None:
        self.moves.append(move)
        self.irrevs.append(irrev)

    def pop(self) -> tuple[Move, tuple[Piece, Castling, Square, Counter, int]]:
