...
class History:
    ...
    def append(self, move: Move, castling_rights: int,
    ...
    def pop(self) -> tuple[Move, int, Square | None, int, list[Move]]:
        return (self.move_history.pop(),) + self.position_data_history.pop()
