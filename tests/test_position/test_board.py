...
q . . . . . b ."""
    ...
    assert board.is_attacked(Square.F2, Color.WHITE)
    assert board.is_attacked(Square.F8, Color.BLACK)
    assert board.is_attacked(Square.C5, Color.WHITE)
